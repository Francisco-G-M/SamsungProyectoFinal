...
Primero, clona el proyecto en tu máquina local y navega al directorio. En bash:
...
Con el entorno activado y las claves configuradas, ya puedes ejecutar el bot.
...
El diseño del proyecto está pensado para la expansión y la integración con sistemas externos. Es decir, tiene el potencial de:
